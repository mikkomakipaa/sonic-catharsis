...
// 2-column grid), each a compact pill rather than a full-width cell, with
// the same amber-tint selected state used throughout the intake form.
        ...
        {DURATION_TIERS.map((d, index) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex items-center justify-center text-center px-2 py-2.5 min-h-[44px] rounded-md cursor-pointer',
                ...
                'max-[480px]:rounded-none max-[480px]:justify-start max-[480px]:gap-2.5 max-[480px]:px-3',
                index > 0 && 'max-[480px]:border-t'
              )}
              style={{
                borderColor: '#e6e2d8',
                background: isSelected ? 'rgba(201,138,75,0.08)' : 'transparent',
